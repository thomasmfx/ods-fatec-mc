        ...
        <div className={`screen active ${styles.screenConfirmacao}`}>
            <Hero variant="green">
                <div style={{ textAlign: 'center' }}>
                    ...
                    <p>Obrigado pela sua participação.<br />Seu certificado foi gerado e será enviado por e-mail.</p>
                </div>
            </Hero>
            ...
            <div className="scroll" style={{ background: 'var(--green-pale)' }}>
                <div className={styles.confCard}>
                    <div className={styles.confRow}>
                        ...
                        <div className={styles.confRowBody}>
                            ...
                            <span className={styles.emailHighlight}>{participante.email}</span>
                        </div>
                    </div>
                    <div className={styles.confRow}>
                ...
                {pdfUrl ? (
                    <div style={{ margin: '0 20px 24px' }}>
                        <div className={styles.certLabel} style={{ textAlign: 'center', marginBottom: '8px' }}>PRÉVIA DO CERTIFICADO</div>
                        <iframe 
                            src={pdfUrl} 
                            width="100%" 
                            style={{ 
                    ...
                    <div className={styles.certPreview}>
                        ...
                        <div className={styles.certDesc}>
                            participou da Etapa Livre da 1ª Conferência Nacional ODS<br />
                            realizada na Fatec Mogi das Cruzes — 28 de março de 2026
                        </div>
                    </div>
                )}

                <div style={{ background: 'rgba(45, 106, 79, 0.08)', borderRadius: '14px', padding: '14px 16px', marginBottom: '16px', fontSize: '13px', color: 'var(--green)', borderLeft: '3px solid var(--green-mid)', margin: '0 20px' }}>
