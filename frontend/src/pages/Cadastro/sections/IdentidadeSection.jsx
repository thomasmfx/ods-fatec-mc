...
export default function IdentidadeSection({ form, opcoes, handleChange }) {
  return (
    <div className={styles.formSection}>
      ...
      <div className="field">
        <label htmlFor="genero" className="field-label">
        ...
        <select
          ...
          onChange={(e) =>
            handleChange('identidadeGeneroId', Number(e.target.value))
          }
        >
      ...
      <div className="field">
        <label htmlFor="orientacao" className="field-label">
          Orientação sexual *
        </label>
        <select
          id="orientacao"
          ...
          onChange={(e) =>
            handleChange('orientacaoSexualId', Number(e.target.value))
          }
        >
          <option value="">Selecione...</option>
      ...
      <div className="field">
        <label htmlFor="raca" className="field-label">
          Raça/cor *
        </label>
        <select
          id="raca"
