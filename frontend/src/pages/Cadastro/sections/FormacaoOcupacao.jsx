...
export default function FormacaoOcupacaoSection({
  form,
  opcoes,
  handleChange,
}) {
    ...
    <div className={styles.formSection}>
      ...
      <fieldset className="field">
        ...
        {opcoes.areasFormacao.map((o) => (
          <label
            key={o.id}
            className={optionCardClass(form.areasFormacaoIds.includes(o.id))}
          >
            <input
              type="checkbox"
              ...
              onChange={() =>
                handleChange(
                  'areasFormacaoIds',
                  toggleList(form.areasFormacaoIds, o.id)
                )
              }
            />
      ...
      <div className="field">
        <label htmlFor="ocupacao" className="field-label">
          Ocupação principal *
        </label>
        <input
          id="ocupacao"
