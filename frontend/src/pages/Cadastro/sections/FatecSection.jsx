    ...
    <div className={styles.formSection}>
      ...
      <fieldset className="field">
        ...
        {opcoes.publicosFatec.map((o) => (
          <label
            key={o.id}
            className={optionCardClass(form.publicosFatecIds.includes(o.id))}
          >
            <input
              type="checkbox"
              ...
              onChange={() =>
                handleChange(
                  'publicosFatecIds',
                  toggleList(form.publicosFatecIds, o.id)
                )
              }
            />
      ...
      <div className="field">
        <label htmlFor="tipoParticipante" className="field-label">
        ...
        <select
          ...
          onChange={(e) =>
            handleChange('tipoParticipanteId', Number(e.target.value))
          }
        >
