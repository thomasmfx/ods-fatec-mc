...
export default function AcessibilidadeSection({ form, opcoes, handleChange }) {
  return (
    <div className={styles.formSection}>
          ...
          <div
            ...
            onKeyDown={(e) => {
              if (e.key === 'Enter' || e.key === ' ') {
                handleChange('possuiDeficiencia', value);
                e.preventDefault();
              }
            }}
          >
      ...
      {form.possuiDeficiencia === true && (
        <fieldset className="field">
          ...
          {opcoes.deficiencias.map((o) => (
            <label
              key={o.id}
              className={optionCardClass(form.deficienciasIds.includes(o.id))}
            >
              <input
                type="checkbox"
                ...
                onChange={() =>
                  handleChange(
                    'deficienciasIds',
                    toggleList(form.deficienciasIds, o.id)
                  )
                }
              />
      ...
      <div className="field">
        <label htmlFor="acessibilidade" className="field-label">
          Recurso de acessibilidade específico
        </label>
        <textarea
          id="acessibilidade"
          ...
          onChange={(e) =>
            handleChange('recursoAcessibilidade', e.target.value)
          }
        />
      </div>
    </div>
