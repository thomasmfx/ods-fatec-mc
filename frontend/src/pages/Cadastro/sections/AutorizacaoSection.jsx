    ...
    <div className={styles.formSection}>
      ...
      <label className={optionCardClass(form.autorizacaoImagem)}>
        <input
          ...
          onChange={() =>
            handleChange('autorizacaoImagem', !form.autorizacaoImagem)
          }
        />
        ...
        <span className={styles.textSpan}>
          Autorizo o uso de imagem e som de voz em fotos, vídeos e demais
          registros para divulgação da 1ª Conferência Nacional ODS. *
        </span>
      </label>
    </div>
  );
