...
export default function VinculosSection({ form, opcoes, handleChange }) {
    const instituicaoSelecionada = opcoes.instituicoes.find((i) => i.id === form.instituicaoId)
    ...
    return (
        <div className={styles.formSection}>
            ...
            <div className="field" role="radiogroup">
                <span className="field-label">Pertence a alguma cadeia produtiva local?</span>
                {[
                    ...
                    <div
                        ...
                        onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { handleChange('pertenceCadeiaProdutiva', value); e.preventDefault() } }}
                    >
            ...
            {form.pertenceCadeiaProdutiva === true && (
                <fieldset className="field">
                    ...
                    {opcoes.cadeiasProdutivas.map((o) => (
                        <label key={o.id} className={optionCardClass(form.cadeiasProdutivosIds.includes(o.id))}>
                            <input
                                type="checkbox"
                                checked={form.cadeiasProdutivosIds.includes(o.id)}
                                onChange={() => handleChange('cadeiasProdutivosIds', toggleList(form.cadeiasProdutivosIds, o.id))}
                            />
            ...
            <div className="field">
                ...
                <select
                    ...
                    onChange={(e) => handleChange('instituicaoId', Number(e.target.value))}
                >
            ...
            {isOutro && (
                <div className="field">
                    <label htmlFor="instituicaoOutro" className="field-label">Qual instituição?</label>
                    <input
                        id="instituicaoOutro"
                        type="text"
