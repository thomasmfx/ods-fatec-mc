    ...
    return (
        <div className={styles.formSection}>
            ...
            <fieldset className="field">
                {opcoes.eixos.map((o) => (
                    <label key={o.id} className={optionCardClass(form.eixosInteresseIds.includes(o.id))}>
                        <input
                            type="checkbox"
                            checked={form.eixosInteresseIds.includes(o.id)}
                            onChange={() => handleChange('eixosInteresseIds', toggleList(form.eixosInteresseIds, o.id))}
                        />
                        <div className="mark mark-sq"><div className="mark-check">✓</div></div>
                        <span>{o.nome} — {o.descricao}</span>
                    </label>
                ))}
            </fieldset>
        </div>
