...
export default function Cadastro() {
    ...
    if (loading) return <div className="scroll"><p style={{ padding: '2rem' }}>Carregando formulário...</p></div>
    ...
    return (
        <div className={`screen active ${styles.screen}`} id="screen-cadastro">
            ...
            <div className="scroll">
                ...
                <IdentidadeSection form={form} opcoes={opcoes} handleChange={handleChange} />
                <AcessibilidadeSection form={form} opcoes={opcoes} handleChange={handleChange} />
                <LocalizacaoSection form={form} opcoes={opcoes} handleChange={handleChange} />
                <VinculosSection form={form} opcoes={opcoes} handleChange={handleChange} />
                <FormacaoOcupacaoSection form={form} opcoes={opcoes} handleChange={handleChange} />
                <FatecSection form={form} opcoes={opcoes} handleChange={handleChange} />
                <EixosInteresseSection form={form} opcoes={opcoes} handleChange={handleChange} />
