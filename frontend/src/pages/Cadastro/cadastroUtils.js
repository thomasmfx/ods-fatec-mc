      ...
      propostas: [
        {
          ...
          descricao:
            'Criação de mecanismos de transparência e controle social nas instituições públicas municipais.',
        },
        {
          id: 2,
          titulo: 'Participação cidadã nos processos decisórios',
          descricao:
            'Implementação de plataformas digitais para consulta pública e engajamento da sociedade.',
        },
      ],
    },
    {
      ...
      propostas: [
        {
          ...
          descricao:
            'Programa de compostagem e coleta seletiva em bairros da cidade com metas anuais.',
        },
        {
          id: 4,
          titulo: 'Arborização urbana e corredores verdes',
          descricao:
            'Plantio de espécies nativas em vias públicas e criação de corredores ecológicos urbanos.',
        },
      ],
    },
    {
      ...
      propostas: [
        {
          ...
          descricao:
            'Criação de hub de inovação com suporte técnico e financeiro para empreendedores locais.',
        },
        {
          id: 8,
          titulo: 'Capacitação digital para trabalhadores',
          descricao:
            'Programa de letramento digital para trabalhadores de setores tradicionais em transição.',
        },
      ],
    },
    {
      ...
      propostas: [
        {
          ...
          descricao:
            'Plataforma de votação online para alocação de parte do orçamento municipal pelos cidadãos.',
        },
        {
          id: 10,
          titulo: 'Conselhos municipais fortalecidos',
          descricao:
            'Revisão das estruturas dos conselhos municipais para maior representatividade deliberativa.',
        },
      ],
    },
  ],
